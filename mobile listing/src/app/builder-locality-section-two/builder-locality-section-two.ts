...
@Component({
  selector: 'app-builder-locality-section-two',
  ...
  templateUrl: './builder-locality-section-two.html',
  styleUrl: './builder-locality-section-two.css',

})
export class BuilderLocalitySectionTwo implements AfterViewInit {
  ...
  localname_seo: any;
  getcity() {
    BuilderLocalitySectionTwo.buildercount = 29;
  ...
  loadMore() {
    ...
    this.routeSub = this.activeroute.params.subscribe(params => {
      ...
      const limit = BuilderLocalitySectionTwo.buildercount += 4;
  ...
  onReset() {
    BuilderLocalitySectionTwo.buildercount = 28;
