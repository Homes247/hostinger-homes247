...
@Component({
  selector: 'app-individual-plot-list',
  imports: [
    CommonModule,
    FormsModule,
    ReactiveFormsModule,
  ...
  templateUrl: './individual-plot-list.html',
  styleUrl: './individual-plot-list.css',
})
export class IndividualPlotList implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private titleService: Title, private meta: Meta,
    ...
    private fb: FormBuilder, private Filter: FilterService,
  ...
  ngOnInit() {
    ...
    // this.scripts();
    // this.onresize();
    IndividualPlotList.citycount = 0;
  ...
  getindividuallist() {
    IndividualPlotList.citycount = 4;
    this.routeSub = this.activeroute.params.subscribe(params => {
      ...
      var param1 = { proptypeid: '50403' }
      // console.log(param)
      this.Service.getindividualprojectscount(this.citynameurl, param).subscribe(countprojects => {
      ...
      this.Service.getIndividualList(this.citynameurl, param).subscribe(lists => {
  ...
  loadMore() {
    ...
    this.routeSub = this.activeroute.params.subscribe(params => {
      ...
      // const limit = IndividualPlotList.citycount += 4;
      const limit = IndividualPlotList.citycount;
      IndividualPlotList.citycount += 4;
      ...
      if (livecount < totalcount) {
        return this.Service.getIndividualList(this.citynameurl, param).subscribe(propertylists => {
  ...
  SubmitForm() {
    ...
    var propertyname = this.propbhk + '-' + this.propareatype + '-' + this.propname;
  ...
  CompareNow() {
    ...
    this.storage.setItem('page_type', 'plot')
