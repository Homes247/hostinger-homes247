...
import { cleanUrlPipe } from '../mainpipe-pipe';
...
//  isTooltipVisible = false;
  ...
  constructor( private activatedRoute: ActivatedRoute,
   public Service: DataService, public Service2: DataService2,private router: Router, @Inject(DOCUMENT) private doc: Document, public cityservice: CityService,private titleService: Title, private meta: Meta,public location: Location,) {
    this.window = this.doc.defaultView as Window & typeof globalThis;
  }
  // private routeSub: Subscription;

  ngOnInit(): void {
    // console.log('This from apex card3')
    this.dataloads();
