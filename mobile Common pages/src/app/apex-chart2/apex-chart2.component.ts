...
declare var $: any;
@Component({
  selector: 'app-apex-chart2',
  templateUrl: './apex-chart2.component.html',
  styleUrls: ['./apex-chart2.component.css']
})
export class ApexChart2Component implements OnInit {
...
// To unmark the radio button
  ...
  dataloads() {
    ...
    this.Service.getNearLocality(localityid).subscribe(prop => {
      ...
      if (this.nearByLocality[0].pricetrends.length === 0) {
      ...
      if (this.nearByLocality.length === 0) {
        this.nearByLocalitys = false;
      } else {
        this.nearByLocalitys = true;
      }
  ...
  affordablePropDetails() {
    ...
    this.Service.getCity(this.cityname, param).subscribe((response) => {
      ...
      if (this.affordablePropList.length === 0 ){
        this.affordablePropListt = false;
      }else{
        this.affordablePropListt = true;
      }
