...
declare var $: any;
@Component({
  selector: 'search-dropdown-main-city',
  templateUrl: 'search-dropdown-main-city.component.html',
  styleUrls: ['search-dropdown-main-city.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SearchDropdownMainCityComponent),
      multi: true,
    },
  ],
})
export class SearchDropdownMainCityComponent implements ControlValueAccessor {
  list = [];
  temp_list = [];
  keyword = '';
  _img: any;
