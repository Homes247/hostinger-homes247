...
export class DataService {
  ...
  private REST_API_SERVER_rentals2_Hari = 'http://192.168.0.120/right2shout_LIVE/Rentalbackend/';

  private REST_API_SERVER_Individuallist2 = 'https://api.right2shout.in/individuallistbackend/';
  private REST_API_SERVER_Individuallist2_Hari = 'http://192.168.0.119/right2shout_LIVE/individuallistbackend/';



  private REST_API_SERVER_Individuallist2_hari = 'http://192.168.0.120/right2shout_LIVE/Individuallistbackend/';
  ...
  private Commercial_post_hari = 'http://192.168.0.120/right2shout_LIVE/commercial_backend/';
  private PG = 'https://mpg.homes247.in/pg_backend/';
  private PG_post = 'https://api.right2shout.in/pg_backend/';
  private PG_post_hari = 'http://192.168.0.120/right2shout_LIVE/pg_backend/';
  ...
  public getlocationlist(): Observable<any> {
    ...
    const apiRequest = this.httpClient.get(
      this.REST_API_SERVER + 'get_location'
    ).pipe(
      shareReplay(1),
      catchError((err) => {
        console.error(err);
  ...
  postPropertyPg(param) {
    const options = toHttpParams(param);
    const req = this.httpClient.post(this.PG_post + 'post_property_hari', options).pipe(retry(0), catchError(this.handleError));
    return this.srv(`post_pg_${param.Phone_number}`, req, null);
  }

  postPropertyCommercial(param) {
    const options = toHttpParams(param);
    const req = this.httpClient.post(this.Commercial_post + 'post_property_hari', options).pipe(retry(0), catchError(this.handleError));
  ...
  postlisting(param) {
    const req = this.httpClient.post(this.REST_API_SERVER_Individuallist2 + 'postpropertytest_hari', toHttpParams(param)).pipe(retry(0), catchError(this.handleError));
    return this.srv(`post_ind_${param.Userid}`, req, null);
  }

  postrentlisting(param) {
    const req = this.httpClient.post(this.REST_API_SERVER_rentals2 + 'postpropertytest_hari', toHttpParams(param)).pipe(retry(0), catchError(this.handleError));
  ...
  mouseenterlisten1(): Observable<any> { return this.mouseenter_listners1.asObservable(); }
  mouseenterservice1() { this.mouseenter_listners1.next(); }
  mouseenterlisten2(): Observable<any> { return this.mouseenter_listners2.asObservable(); }
  mouseenterservice2() { this.mouseenter_listners2.next(); }
  mouseenterlisten3(): Observable<any> { return this.mouseenter_listners3.asObservable(); }
  mouseenterservice3() { this.mouseenter_listners3.next(); }
  mouseenterlisten4(): Observable<any> { return this.mouseenter_listners4.asObservable(); }
  mouseenterservice4() { this.mouseenter_listners4.next(); }
  mouseenterlisten5(): Observable<any> { return this.mouseenter_listners5.asObservable(); }
  mouseenterservice5() { this.mouseenter_listners5.next(); }
  mouseenterlisten6(): Observable<any> { return this.mouseenter_listners6.asObservable(); }
  mouseenterservice6() { this.mouseenter_listners6.next(); }
  mouseenterlisten7(): Observable<any> { return this.mouseenter_listners7.asObservable(); }
  mouseenterservice7(data: string) { this.mouseenter_listners7.next(data); }
  mouseenterlistenOtp(): Observable<any> { return this.mouseenter_listnersOtp.asObservable(); }
  mouseenterserviceOtp() { this.mouseenter_listnersOtp.next(); }
  mouseenterlistenOtp2(): Observable<any> { return this.mouseenter_listnersOtp2.asObservable(); }
  mouseenterserviceOtp2() { this.mouseenter_listnersOtp2.next(); }
