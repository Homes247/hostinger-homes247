...
@Injectable()
export class ServerResponseService_upcoming {
  ...
  setStatus(code: number,  City_Seo?:string, Locality_Seo?:string, localityid?:number,  ): this {
    if (this.response) {
      this.response.redirect(code, "https://www.homes247.in/upcoming-new-launch-properties/new-projects-in-"+ Locality_Seo +"-"+ City_Seo +"-"+ localityid);
    }
    return this;
  }
