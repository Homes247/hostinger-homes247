...
declare var $: any;
@Component({
  selector: 'app-pin-code2',
  templateUrl: './pin-code2.component.html',
  styleUrls: ['./pin-code2.component.css']
})
export class PinCode2Component implements OnInit {
  // STATE: any;
  address: any;
  TALUK: any;
  StateName: any;
  ...
  fetchstateNAme() {
    this.routeSub = this.activeroute.params.subscribe(params => {
      ...
      this.titleService.setTitle('Find Pin Code Numbers in India, ' + this.State_Name_Seo + ', ' + this.District_Name_Seo +' | Homes247');
      this.meta.updateTag({
        name: 'description',
        content: 'Find PIN Code (Postal Index Number Code) for ' + this.State_Name_Seo + ', ' + this.District_Name_Seo +' on Homes247. Get Accurate Pin Codes or Zip Codes'
      });
      ...
      this.service1.getPinCode(param1).subscribe(lists => {
        ...
        this.testingtaluk1 = this.ApiTalukName.length;
        this.testingtaluk2 = this.ApiTalukName.length/2
