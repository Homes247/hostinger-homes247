...
@Injectable()
export class ServerResponseService_btlc_apartments {
  ...
  setStatus(code: number, noOfBedrooms?:number, City_Seo?:string, Locality_Seo?:string, localityid?:number,  ): this {
    if (this.response) {
      this.response.redirect(code, "https://www.homes247.in/btlc/"+noOfBedrooms+"-bhk-flats-apartments-in-"+Locality_Seo+"-"+City_Seo+"-"+localityid);
    }
    return this;
  }
