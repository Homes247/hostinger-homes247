...
declare var $: any;
@Component({
  selector: 'app-search-dropdown-taluk',
  templateUrl: './search-dropdown-taluk.component.html',
  styleUrls: ['./search-dropdown-taluk.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SearchDropdownTalukComponent),
      multi: true,
    },
  ],
})
export class SearchDropdownTalukComponent implements ControlValueAccessor {
  ...
  ValuePAssing() {
    this.routeSub = this.activeroute.params.subscribe(params => {
      // var BankName = params['Taluk_Name'].replace(/-/g, ' ');
      // this.value = BankName;
      const BankName = params['Taluk_Name'] || '';
