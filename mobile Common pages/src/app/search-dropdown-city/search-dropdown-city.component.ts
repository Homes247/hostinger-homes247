...
declare var $: any;
@Component({
  selector: 'search-dropdown-city',
  templateUrl: 'search-dropdown-city.component.html',
  styleUrls: ['search-dropdown-city.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SearchDropdownCityComponent),
      multi: true,
    },
  ],
})
export class SearchDropdownCityComponent implements ControlValueAccessor {
  list = [];
  temp_list = [];
  keyword = '';
  _img: any;
