...
export class EnquiryFormComponent implements OnInit {
  ...
  addenquiry() {
    ...
    if (value.cityname == undefined || null) {
      ...
      if (success['status'] === 'True') {
        ...
        if (success['code'] === "3") {
          ...
          if (this.router.url.indexOf('#downloadbrochure') > -1) {
            ...
            if ('contactedPropId' in this.Local_Storage) {
              this.contactedRentalarr = JSON.parse(this.Local_Storage.getItem('contactedPropId') || '[]');
            } else {
            ...
            if (!this.contactedRentalarr.includes(this.Filter.propid)) {
              ...
              this.Local_Storage.setItem('contactedPropId', JSON.stringify(this.contactedRentalarr));
            }
