...
@Component({
  selector: 'app-pg-locality-sitemap',
  templateUrl: './pg-locality-sitemap.component.html',
  styleUrls: ['./pg-locality-sitemap.component.css']
})
export class PgLocalitySitemapComponent implements OnInit {
  completedata: any;
  routeSub: any;
  cityname: any;
  cityid: any;
  ...
  city: any;
  getmeta() {
    var cityname = this.router.url.split('/all-localities-by-pg-city')[1];
    // 
