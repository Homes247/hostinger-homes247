...
declare var $: any;
@Component({
  selector: 'app-post-property-guidelines',
  templateUrl: './post-property-guidelines.component.html',
  styleUrls: ['./post-property-guidelines.component.css']
})
export class PostPropertyGuidelinesComponent implements OnInit {
