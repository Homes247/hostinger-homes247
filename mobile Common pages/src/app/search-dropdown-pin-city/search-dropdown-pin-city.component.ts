...
declare var $: any;
@Component({
  selector: 'app-search-dropdown-pin-city',
  templateUrl: './search-dropdown-pin-city.component.html',
  styleUrls: ['./search-dropdown-pin-city.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => SearchDropdownPinCityComponent),
      multi: true,
    },
  ],
})

export class SearchDropdownPinCityComponent implements ControlValueAccessor {
