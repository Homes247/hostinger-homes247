...
import {ServerResponseService_floorplans} from '../server-response-propertydetails.service'
import { FilterService } from '../filter.service';


declare var $: any;
@Component({
  selector: 'app-property-floorplans',
  templateUrl: './property-floorplans.component.html',
  styleUrls: ['./property-floorplans.component.css'],
  providers: [ServerResponseService_floorplans],

})
export class PropertyFloorplansComponent implements OnInit {
  ...
  constructor(private router: Router,public Service2: DataService2,public Filter: FilterService,public responseService: ServerResponseService_floorplans,public Service: DataService, private _messageService: MessageService,public location: Location, private titleService: Title, private meta: Meta, public activatedRoute : ActivatedRoute) {
...
this.activatedRoute.queryParams.subscribe(params => {
  ...
  if(this.currentTab == 'BHK1'){
    ...
    var propid = this.router.url.split('-').pop().match(/[0-9]+/);
        ...
        var urlstructure1 = '/fpl/'+propName+'-in-'+localityName+'-'+cityName+'-floorplans-'+propid
        ...
        this.titleService.setTitle(this.propName +' - Floor Plans, '+ this.localityName +', '+ this.cityName);
        this.meta.updateTag({
          name: 'description',
          content: 'Explore the variety of floor plans and pricing options at '+ this.propName +', available exclusively at Homes247.in. Find the perfect layout for your dream home today.'
        });
