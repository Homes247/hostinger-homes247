...
declare var $: any;
@Component({
  selector: 'app-review-locality-one',
  templateUrl: './review-locality-one.component.html',
  styleUrls: ['./review-locality-one.component.css']
})
export class ReviewLocalityOneComponent implements OnInit {
 ...
 propTypeId = '50401'
  ...
  onTouchLoad() {
    import('../apex-chart1/apex-chart1.module').then(mod => mod.ApexChart1Module).then(ApexChart1Module => {
      this.Apex = ApexChart1Module.components['lazy'];
