...
@Component({
  selector: 'app-sitemap-commercial-locality',
  templateUrl: './sitemap-commercial-locality.component.html',
  styleUrls: ['./sitemap-commercial-locality.component.css']
})
export class SitemapCommercialLocalityComponent implements OnInit {
  completedata: any;
  routeSub: any;
  cityname: any;
  cityid: any;
  ...
  city: any;
  getmeta() {
    var cityname = this.router.url.split('/all-localities-by-commercial-city')[1];
    // 
